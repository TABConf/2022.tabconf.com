...
(function($) {
	...
	$( document ).ready(function() {
		...
		new UABBWooProducts({
			id: 'csiatm0ewq9j',
			ajaxurl: "https://2022.tabconf.com/wp-admin/admin-ajax.php",
			is_cart: false,
			view_cart: 'View cart',
			cart_url: 'https://2022.tabconf.com/cart/',
			layout: "grid",
			skin: "classic",
