...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-uigblahd3woq .fl-photo-img' )
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-cjkr02wzbius .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-hc7ru6yfow0k .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-eu3vzmbdwn6f .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-yjzpmn71528f .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-cvrf7y2hqme4 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-qtlrdsj4pefk .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-phb8jymd6gx9 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-hvm7pka9w5s8 .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-duxw3i1rpavn .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-z72e9856d0ip .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
jQuery(function($) {
		...
		$(function() {
		$( '.fl-node-9y2vjtqwolgn .fl-photo-img' )
			.on( 'mouseenter', function( e ) {
				$( this ).data( 'title', $( this ).attr( 'title' ) ).removeAttr( 'title' );
			} )
			.on( 'mouseleave', function( e ){
...
(function($) {
	...
	jQuery(document).ready( function() {
		...
		if ( pattern.test( hashval ) ) {
			...
			if( hashval != '' ) {
				...
				jQuery('.fl-node-xls41qcid68m .uabb-masonary-filters li').removeClass('uabb-masonary-current');

				jQuery('.fl-node-xls41qcid68m .uabb-masonary-filters li[data-filter=".uabb-masonary-cat-' + hashval + '"]').addClass('uabb-masonary-current');

				jQuery( '.fl-node-xls41qcid68m .uabb-masonary-filters .uabb-masonary-filter-xls41qcid68m.uabb-masonary-current' ).trigger('click');
			}
		}
	...
	new UABBBlogPosts( args );
		jQuery(window).on('load', function() {
		jQuery('.fl-node-xls41qcid68m .uabb-blog-posts-grid').isotope('layout');
	});
...
(function($) {
	...
	jQuery(document).ready( function() {
		...
		if ( pattern.test( hashval ) ) {
			...
			if( hashval != '' ) {
				...
				jQuery('.fl-node-q94zwa1c0hmp .uabb-masonary-filters li').removeClass('uabb-masonary-current');

				jQuery('.fl-node-q94zwa1c0hmp .uabb-masonary-filters li[data-filter=".uabb-masonary-cat-' + hashval + '"]').addClass('uabb-masonary-current');

				jQuery( '.fl-node-q94zwa1c0hmp .uabb-masonary-filters .uabb-masonary-filter-q94zwa1c0hmp.uabb-masonary-current' ).trigger('click');
			}
		}
	...
	new UABBBlogPosts( args );
		jQuery(window).on('load', function() {
		jQuery('.fl-node-q94zwa1c0hmp .uabb-blog-posts-grid').isotope('layout');
	});
...
(function($) {
	...
	jQuery(document).ready( function() {
		...
		if ( pattern.test( hashval ) ) {
			...
			if( hashval != '' ) {
				...
				jQuery('.fl-node-u3fc8kewvb7r .uabb-masonary-filters li').removeClass('uabb-masonary-current');

				jQuery('.fl-node-u3fc8kewvb7r .uabb-masonary-filters li[data-filter=".uabb-masonary-cat-' + hashval + '"]').addClass('uabb-masonary-current');

				jQuery( '.fl-node-u3fc8kewvb7r .uabb-masonary-filters .uabb-masonary-filter-u3fc8kewvb7r.uabb-masonary-current' ).trigger('click');
			}
		}
	...
	new UABBBlogPosts( args );
		jQuery(window).on('load', function() {
		jQuery('.fl-node-u3fc8kewvb7r .uabb-blog-posts-grid').isotope('layout');
	});
