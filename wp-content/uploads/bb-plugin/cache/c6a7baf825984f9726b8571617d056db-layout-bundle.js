...
(function($) {
	...
	jQuery(document).ready( function() {
		...
		if ( pattern.test( hashval ) ) {
			...
			if( hashval != '' ) {
				...
				jQuery('.fl-node-60e3c5b319447 .uabb-masonary-filters li').removeClass('uabb-masonary-current');

				jQuery('.fl-node-60e3c5b319447 .uabb-masonary-filters li[data-filter=".uabb-masonary-cat-' + hashval + '"]').addClass('uabb-masonary-current');

				jQuery( '.fl-node-60e3c5b319447 .uabb-masonary-filters .uabb-masonary-filter-60e3c5b319447.uabb-masonary-current' ).trigger('click');
			}
		}
	...
	new UABBBlogPosts( args );
		jQuery(window).on('load', function() {
		jQuery('.fl-node-60e3c5b319447 .uabb-blog-posts-grid').isotope('layout');
	});
